...
public class ApertiumMain {
    ...
    private static void _dispatchPipeline(Mode mode, 
        ...
        //arink
        Dispatcher.dispatch(clp.deformatter, clp.extInput, output, null, clp.dispAmb, 
                clp.dispMarks);
                ...
                switch(currProg.getProgram()) {
                    ...
                    default:
                        ...
                        Dispatcher.dispatch(currProg, input, output, 
                                null, clp.dispAmb, clp.dispMarks);
                        break;
                }
            }
        } catch (UnsupportedEncodingException e) {
        ...
        input = new StringReader(output.toString());
        Dispatcher.dispatch(clp.reformatter, input, clp.extOutput, null, clp.dispAmb, 
                clp.dispMarks);
    }
