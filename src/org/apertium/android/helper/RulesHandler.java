...
public class RulesHandler extends SecureClassLoader{
	...
	public DexClassLoader getClassLoader(){
		Log.d(TAG,"PathCurrentPackage ="+PathCurrentPackage()+"/classes.jar, ODEX path="+this._tmpDIR.getAbsolutePath());
		return new DexClassLoader(PathCurrentPackage()+"/classes.jar",this._tmpDIR.getAbsolutePath(), null, this.getClass().getClassLoader());
	}
